...
//      if(any.isInstanceOf[Pos]) {
//    	val ref = any.asInstanceOf[Pos]
//    	x.equals(ref.x) && y.equals(ref.y)
//      } else {
//    	false
//      }
    
//    def equals(pos: Pos): Boolean = 
//      x.equals(pos.x) && y.equals(pos.y) 
  }
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     */
    def neighbors: List[(Block, Move)] = List((startBlock.left, Left), (startBlock.right, Right), (startBlock.up, Up), (startBlock.down, Down))

    /**
     * Returns the list of positions reachable from the current block
     * which are inside the terrain.
     */
    def legalNeighbors: List[(Block, Move)] = neighbors filter (entry => entry._1.isLegal)
    

    /**
     * Returns `true` if the block is standing.
     */
    def isStanding: Boolean = b1.x.equals(b2.x) && b1.y.equals(b2.y)
...
//    override def equals(any: Any): Boolean = 
//      if(any.isInstanceOf[Block]) {
//        val ref = any.asInstanceOf[Block]
//        b1.equals(ref.b1) && b2.equals(ref.b2)
//      } else {
//        false
//      }
     
//    def equals(block: Block): Boolean = 
//      b1.equals(block.b1) && b2.equals(block.b2)
  }
}
